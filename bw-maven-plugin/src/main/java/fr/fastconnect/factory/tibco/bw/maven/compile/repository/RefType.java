...
/**
 * <p>Classe Java pour refType complex type.
 * 
 ...
 *       &lt;attribute name="isRef" use="required" type="{http://www.w3.org/2001/XMLSchema}boolean" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
@XmlSeeAlso({
    GlobalNameRefType.class,
    SchemaGlobalNameRefType.class
})
public class RefType {
    ...
    /**
     * Obtient la valeur de la propriété isRef.
     * 
     */
    ...
    /**
     * Définit la valeur de la propriété isRef.
     * 
     */
